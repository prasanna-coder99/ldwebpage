...
function Footer({ onNavClick }){
  return (
    <section id="contact-cta" className="bg-black py-20 px-6 sm:px-12 lg:px-24">
      <div
        className="relative w-full h-[350px] md:h-[500px] bg-cover bg-center rounded-2xl flex items-center justify-center overflow-hidden"
        style={{
      ...
      >
        <div className="relative z-10 text-white text-center p-4">
          ...
          <button onClick={() => onNavClick("contact")} className="px-8 py-5 bg-white text-gray-800 text-lg font-book rounded-lg shadow-lg transition-all duration-300 hover:bg-[#a374ff] hover:scale-105">
            Get in Touch
          </button>
        </div>
      </div>
