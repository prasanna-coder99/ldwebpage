  ...
  return (
    ...
    <section className="w-full [min-width:2500px]:w-[2500px] bg-black py-20 text-center mt-10">
      <div className="mx-auto px-4 [min-width:2500px]:px-[500px] [min-width:2500px]:pt-20">
        <h1 className=" text-4xl md:text-5xl lg:text-5xl xl:text-7xl [min-width:2500px]:text-8xl font-black uppercase tracking-wide font-medium leading-tight }"
        style={{
        ...
        textFillColor: "transparent"
         ...
         <span className="inline-flex items-center gap-3 [min-width:2500px]:gap-4">
          ...
          CRAFTING 
         <video autoPlay muted loop playsInline className="hidden sm:inline-block w-[180px] h-20 rounded-[30px]  [min-width:2500px]:w-[180px] [min-width:2500px]:h-20 rounded-[30px] [min-width:2500px]:rounded-[30px]   object-cover overflow-clip mx-2 inline-block">
        ...
        <span className="block my-0">DIGITAL FUTURE WITH</span>
          ...
          <span className="flex flex-col sm:flex-row items-center mx-2 [min-width:2500px]:mx-2">
            <img
            ...
            />
         <span className="ml-2">AND PRECISION</span>
          </span>
          
        </h1>
        <p className="text-gray-300 font-normal  text-[24px] [min-width:2500px]:text-3xl min-width:2500px]:mt-6 tracking-wider leading-normal">
