...
const Contact = () => {
  return (
    <section className="text-[#989898] font-medium py-16 px-4 sm:px-8 lg:px-16 w-full [min-width:2500px]:w-[2500px] [min-width:2500px]:mx-auto">
      <div className=" mx-auto flex flex-col lg:flex-row lg:space-x-12 items-stretch">
        <div className="lg:w-1/2 flex">
          <div className="w-full h-full rounded-3xl overflow-hidden">
            <img
              src="https://ldintertech.com/static/media/graphic-download.fc9eebd7660a1f0a6d960b0a2f7d62cb.svg"
              alt="Contact Illustration"
              className="object-cover w-full h-full [min-width:2500px]:max-h-[300px]"
            />
          </div>
        </div>

        <div className="lg:w-1/2 flex flex-col justify-between rounded-3xl p-8 mt-8 lg:mt-0  [min-width:2500px]:h-[800px]">
